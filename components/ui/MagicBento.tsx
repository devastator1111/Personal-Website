...
export interface MagicBentoItem {
  ...
  onClick?: () => void;
  headerContent?: ReactNode; // flexible content for header
  tags?: string[]; // display tags like tags in previous cards
}
...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      (gridRef.current?.querySelectorAll('.magic-bento-card') as NodeListOf<HTMLElement>)?.forEach(card => {
        card.style.setProperty('--glow-intensity', '0');
      });
